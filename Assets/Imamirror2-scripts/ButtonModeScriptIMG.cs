...
public class ButtonModeScriptIMG : MonoBehaviour
{
    ...
    private Image icon_h;
    private Image icon_p;
    ...
    void Start()
    {
        ...
        pre_mode = true;
        //mode_text.text = "実験";
        icon_h = GetComponentInChildren<Image>();
        icon_h.color = Color.gray;
    }
